...
function ContactDescription() {
    return (
        <div className="contact-intro mx-auto mb-12">
            <h3 className="title text-purple mb-8 sm:text-start text-center font-bold text-3xl">إتصل بنا</h3>
            <p className="font-semibold md:text-xl text-grey ">
